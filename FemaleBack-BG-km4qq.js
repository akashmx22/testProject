...
import {
    B as s,
    a as i
} from "../definitions-CfT5K3z1.js";
import {
    j as n
} from "../utils-C3fXrxDZ.js";
import "../purify.es-DwuV7rY0.js";
import "../icons/musclewiki/MobileLogoIcon-BATBCrlM.js";
import "../index-BWUEYic3.js";

function t({
    bodyMapClass: o,
    isJoints: s,
    isWorkoutGenerator: i,
    ...t
}, l) {
    return r.jsxs("svg", {
        ...
        ...t,
        children: [r.jsx("defs", {
            children: r.jsxs("radialGradient", {
                id: "jointradial",
                cx: "50%",
                cy: "50%",
                r: "50%",
            ...
            id: "hands",
            className: e(i ? "text-mw-gray" : `bodymap ${o}`),
            children: [r.jsx("path", {
...
t.propTypes = s, t.defaultProps = i;
const l = o.forwardRef(t);
export {
    l as
    default
};